...
**Generated:** 2026-07-13 21:14 UTC · Tool: `cloc` · Scope: the **13 active** `lentago` repos, measured over their default branches. The 3 archived repos (`office-presence`, `site-pitzilabs-dev`, `workstation-bootstrap`) are frozen and excluded.
...
**Headline:** the fleet's hand-maintained natural-language instruction surface (**3,077 lines**) is among the largest "languages" in the code base. One repo — `reference-checker` — is almost entirely natural-language source: its auditor is a prompt program.

| Code (incl. instructions) | Instruction-markdown | Repos | Data excluded | Generated excluded |
|---:|---:|---:|---:|---:|
| **34,500** | **3,077** (18 files) | 13 | 85,159 | 12,645 |
...
| 5 | **Instructions (CLAUDE.md family + prompt-programs)** | 3,077 | 18 | 8.9% |
| 6 | Python | 2,760 | 19 | 8.0% |
| 7 | JSX | 851 | 10 | 2.5% |
| 8 | JavaScript | 773 | 7 | 2.2% |
| 9 | TypeScript | 304 | 7 | 0.9% |
| 10 | CSS | 258 | 7 | 0.7% |
| 11 | Other (TOML / Dockerfile / …) | 37 | 5 | 0.1% |
| | **CODE TOTAL** | **34,500** | **378** | 100% |
...
| .github | 823 | 114 | 462 | 353 | 0 |
| shared-workflows | 571 | 181 | 83 | 0 | 0 |
| repo-template | 65 | 22 | 46 | 0 | 0 |

## 4 — Markdown taxonomy

The fleet carries **26,863 lines of Markdown across 727 files**; only 11.5% is instruction-code.

| Class | Lines | Files | Disposition |
|-------|------:|------:|-------------|
| **Instructions** | 3,077 | 18 | **counted as code** |
| Content / data | 14,939 | 624 | payload (vault notes, recipes, test-sets) — excluded |
| Documentation | 8,495 | 70 | READMEs, docs, ADRs, runbooks — excluded |
| Community-health | 352 | 15 | CONTRIBUTING/SECURITY/templates — excluded |
| **All Markdown** | **26,863** | **727** | |
